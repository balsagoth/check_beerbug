...
class beerbug(Plugin):
        ...
        data = make_option("-d","--data", dest="data",type="int", help="1=Battery, 2=sg, 3=plato, 4=alcohol, 5=beerbug temperature, 6=probe temperature, 7=process")
        tempunit = make_option("-f", "--farenheit", dest="tempunit", action="store_true", help="Use Farenheit. Only for temperature options")
